...
var Scraper = function(schoolId) {
  ...
  if (schoolId === 28 || 102 || 154 || 162 || 170) {
    console.log(schoolId + ' is not good')
    schoolId++;
  }
  ...
  if (schoolId < 3341) {
    request({
      ...
      if ($('.cp_left').find('h1').text().length < 1) {
        console.log(schoolId + " is unlisted");
      };
